...
public class TestCsw_Order extends Globals {
	...
	@BeforeMethod
	  public void launchUrl() throws Exception {
		...
		new TestCswLogin().coverStoryLogin();
 ...
 //vin comment
  ...
  public void PlaceOrder_AlreadyLoggedin() throws Exception  {
	  ...
	  moveToElement(od.menuCategoryClothing);
	  od.allNewUnderClothingCategory.click();
	  od.plpPage.click();
	  od.selectSize_PDP.click();
	  od.addtoBag_PDP.click();
	  Thread.sleep(3000);
	  od.cartIcon_PDP.click();
	  Thread.sleep(3000);
	  od.viewCartButton_PDP.click();
	  Thread.sleep(3000);
	  od.pinCodeBeforeCheckout.sendKeys(Excelutility.excelData(2, 2, 0));
	  od.proceedToCheckout.click();
	  od.proceedToReview.click();
	  Thread.sleep(3000);
	  od.proceedToPayment.click();
	  od.netBanking.click();
